...
class Migrator
{
    ...
    public function getMapping()
    {
        ...
        $classes = [
            ...
            'PHPExcel_Writer_OpenDocument_Extra' => \PhpOffice\PhpSpreadsheet\Writer\Ods\Extra::class,
            'PHPExcel_Writer_OpenDocument_ExtraInf' => \PhpOffice\PhpSpreadsheet\Writer\Ods\ExtraInf::class,

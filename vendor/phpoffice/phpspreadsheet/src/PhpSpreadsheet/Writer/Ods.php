...
use PhpOffice\PhpSpreadsheet\Writer\Ods\Extra;
use PhpOffice\PhpSpreadsheet\Writer\Ods\ExtraInf;
...
class Ods extends BaseWriter
{
    ...
    public function save($pFilename)
    {
        ...
        $zip->addFromString('meta.xml', $this->getWriterPart('extra')->write());

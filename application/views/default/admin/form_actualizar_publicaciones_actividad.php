								...
								<div class="col-12 col-md-2">
									<div class="card">
										<div class="card-body">
											...
											<div class="form-group">
												<label for="Meta[solo_usuarios]">Mostrar a:</label>
												<select class="form-control" name="Meta[solo_usuarios]">
													<option value="no" <?php if(isset($meta_datos['solo_usuarios'])&&$meta_datos['solo_usuarios']=='no'){ echo 'selected'; } ?>>Todo el mundo</option>
													<option value="si" <?php if(isset($meta_datos['solo_usuarios'])&&$meta_datos['solo_usuarios']=='si'){ echo 'selected'; } ?>>Solo usuarios registrados</option>
												</select>
											</div>
											<div class="form-group">

<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
		...
		<!--begin::Portlet-->
		<form action="<?php echo base_url('admin/municipios/actualizar') ?>" method="post" enctype="multipart/form-data">
			<input type="hidden" name="Identificador" value="<?php echo $municipio['ID_MUNICIPIO']; ?>">
			<input type="hidden" name="IdPais" value="<?php echo $municipio['ID_PAIS']; ?>">
			<input type="hidden" name="IdEstado" value="<?php echo $municipio['ID_ESTADO']; ?>">
							...
							<div class="row">
								<div class="col-8">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="MunicipioNombre" value="<?php echo $municipio['MUNICIPIO_NOMBRE']; ?>" required>
									</div>
									<div class="form-group">
										<label for="MunicipioIso">ISO Municipio <small>Ej. MX</small></label>
										<input type="text" class="form-control" name="MunicipioIso" value="<?php echo $municipio['MUNICIPIO_ISO']; ?>">
									</div>
								</div>
								<div class="col-4">
									<div class="form-group">
										...
										<select class="form-control" name="Estado">
											<option value="activo" <?php if($municipio['ESTADO']=='activo'){ echo 'selected'; } ?>>Activo</option>
											<option value="inactivo" <?php if($municipio['ESTADO']=='inactivo'){ echo 'selected'; } ?>>Inactivo</option>
										</select>
									</div>
								</div>
							</div>

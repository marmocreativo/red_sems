...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url('assets/metronic/'); ?>vendors/custom/jquery-ui/jquery-ui.bundle.min.css" rel="stylesheet" type="text/css" />
		...
		<link href="<?php echo base_url('assets/metronic/'); ?>demo/default/skins/header/base/light.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url('assets/metronic/'); ?>demo/default/skins/header/menu/light.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url('assets/metronic/'); ?>demo/default/skins/brand/dark.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url('assets/metronic/'); ?>demo/default/skins/aside/dark.css" rel="stylesheet" type="text/css" />
		<!--begin::Layout Skins(used by all pages) -->
		<link href="<?php echo base_url('assets/metronic/'); ?>custom.css" rel="stylesheet" type="text/css" />
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="<?php echo base_url('admin'); ?>">
					<img alt="Logo" src="<?php echo base_url('assets/'); ?>img/logo-panduit-w.png" />
				</a>
			</div>
			...
			-->
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
							...
							<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
								<ul class="kt-menu__nav ">
									<li class="kt-menu__item " aria-haspopup="true" >
										<a  href="<?php echo base_url(); ?>" class="kt-menu__link " target="_blank"><span class="kt-menu__link-text">Ir al sitio</span></a>
									</li>
								</ul>
							</div>
						</div>
						...
						<?php //$this->load->view($dispositivo.'/admin/widgets/menu_notificaciones'); ?>
						<?php $this->load->view('default'.$dispositivo.'/admin/widgets/menu_usuario'); ?>

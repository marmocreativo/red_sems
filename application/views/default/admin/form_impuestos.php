<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
		...
		<!--begin::Portlet-->
		<form action="<?php echo base_url('admin/impuestos/crear') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-8">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="ImpuestoNombre" value="" required>
									</div>
									<div class="row">
										<div class="col">
											<div class="form-group">
												<label for="ImpuestoCantidad">Impuesto Cantidad <small>(Solo números)</small></label>
												<input type="number" class="form-control" name="ImpuestoCantidad" value="" required>
											</div>
										</div>
										<div class="col-3">
											<div class="form-group">

<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
		...
		<!--begin::Portlet-->
		<form action="<?php echo base_url('admin/estados/crear') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-8">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="EstadoNombre" value="" required>
									</div>
									<div class="form-group">
										<label for="EstadoIso">ISO Estado <small>Ej. MX</small></label>
										<input type="text" class="form-control" name="EstadoIso" value="" required>
									</div>
								</div>
								<div class="col-4">
									<div class="form-group">

<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
		...
		<!--begin::Portlet-->
		<form action="<?php echo base_url('admin/divisas/crear') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-8">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="DivisaNombre" value="" required>
									</div>
									<div class="form-group">
										<label for="DivisaNombrePlural">Nombre divisa <small>Plural</small></label>
										<input type="text" class="form-control" name="DivisaNombrePlural" value="" required>
									</div>
									<div class="form-group">
										<label for="DivisaIso">Código ISO divisa <small>Ej. MXN / USD</small></label>
										<input type="text" class="form-control" name="DivisaIso" value="" required>
									</div>
									<div class="form-group">
										<label for="DivisaSigno">Signo divisa <small>Ej. $</small></label>
										<input type="text" class="form-control" name="DivisaSigno" value="$" required>
									</div>
									<div class="form-group">
										...
										<select class="form-control" name="DivisaPosicionSigno">
											<option value="izquierda">$xx.xx</option>
											<option value="derecha">xx.xx€</option>
										</select>
									</div>
									<div class="form-group">
										<label for="DivisaCambio">Tipo de cambio <small>En relación a la divisa principal</small></label>
										<input type="number" min="0" step="0.01" class="form-control" name="DivisaCambio" value="1.00" required>
									</div>
								</div>
								<div class="col-4">
									<div class="form-group">

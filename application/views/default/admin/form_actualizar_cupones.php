<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
		...
		<!--begin::Portlet-->
		<form action="<?php echo base_url('admin/cupones/actualizar') ?>" method="post" enctype="multipart/form-data">
			<input type="hidden" name="Identificador" value="<?php echo $cupon['ID_CUPON']; ?>">
							...
							<div class="row">
								<div class="col-8">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="CuponCodigo" value="<?php echo $cupon['CUPON_CODIGO']; ?>" required>
									</div>
									<div class="row">
										<div class="col">
											<div class="form-group">
												<label for="CuponDescuento">Descuento Cupón</label>
												<input type="number" class="form-control" name="CuponDescuento" value="<?php echo $cupon['CUPON_DESCUENTO']; ?>" required>
											</div>
										</div>
										<div class="col-3">
											<div class="form-group">
												...
												<select class="form-control" name="CuponFuncion">
													<option value="porcentaje" <?php if($cupon['CUPON_FUNCION']=='porcentaje'){ echo 'selected'; } ?>>%</option>
													<option value="importe" <?php if($cupon['CUPON_FUNCION']=='importe'){ echo 'selected'; } ?>>$ </option>
												</select>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col">
											<div class="form-group">
												...
												<input type="text" class="form-control datepicker" name="FechaPublicacion" value="<?php echo $cupon['FECHA_PUBLICACION']; ?>">
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												<label for="FechaVigencia">Fecha Vigencia</label>
												<input type="text" class="form-control datepicker" name="FechaVigencia" value="<?php echo $cupon['FECHA_VIGENCIA']; ?>">
											</div>
										</div>
									</div>
								</div>
								<div class="col-4">
									<div class="form-group">
										...
										<select class="form-control" name="Estado">
											<option value="activo" <?php if($cupon['ESTADO']=='activo'){ echo 'selected'; } ?>>Activo</option>
											<option value="inactivo" <?php if($cupon['ESTADO']=='inactivo'){ echo 'selected'; } ?>>Inactivo</option>
										</select>
									</div>
								</div>
							</div>

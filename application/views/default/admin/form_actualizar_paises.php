<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
		...
		<!--begin::Portlet-->
		<form action="<?php echo base_url('admin/paises/actualizar') ?>" method="post" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-8">
									<div class="form-group">
										<label for="PaisNombre">Nombre pais </label>
										<input type="text" class="form-control" name="PaisNombre" value="<?php echo $pais['PAIS_NOMBRE']; ?>" required>
									</div>
									<div class="form-group">
										<label for="PaisIso">ISO Pais <small>Ej. MX</small></label>
										<input type="text" class="form-control" name="PaisIso" value="<?php echo $pais['PAIS_ISO']; ?>" required>
									</div>
								</div>
								<div class="col-4">
									<div class="form-group">
										...
										<select class="form-control" name="Estado">
											<option value="activo" <?php if($pais['ESTADO']=='activo'){ echo 'selected'; } ?>>Activo</option>
											<option value="inactivo" <?php if($pais['ESTADO']=='inactivo'){ echo 'selected'; } ?>>Inactivo</option>
										</select>
									</div>
								</div>
							</div>

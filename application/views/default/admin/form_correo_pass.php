			...
			<div class="kt-portlet__body">
				...
				<div class="kt-section">
					<div class="kt-section__content">
						<?php $no_usuarios = 0; foreach($usuarios as $usuario){ $no_usuarios ++; }?>
						<h2>Usuarios totales: <?php echo $no_usuarios; ?></h2>
						<h3>Correos enviado: <?php echo $correos_enviados; ?></h3>
						<h6>Correos fallidos: <?php echo $correos_fallidos; ?></h6>
					</div>
				</div>
				<!--end::Section-->
			</div>

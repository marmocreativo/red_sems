...
<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
	...
	<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
		...
		<!--begin::Portlet-->
		<form action="<?php echo base_url('admin/transportistas/actualizar') ?>" method="post" enctype="multipart/form-data">
			<input type="hidden" name="Identificador" value="<?php echo $transportista['ID_TRANSPORTISTA']; ?>">
			<input type="hidden" name="ImagenActual" value="<?php echo $transportista['IMAGEN']; ?>">
									...
									<div class="card">
										<div class="card-body">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="TransportistaNombre" value="<?php echo $transportista['TRANSPORTISTA_NOMBRE']; ?>" required>
											</div>
											<div class="form-group">
												<label for="TransportistaResumen">Resumen</label>
												<textarea name="TransportistaResumen" class="form-control" rows="5"><?php echo $transportista['TRANSPORTISTA_RESUMEN']; ?></textarea>
											</div>
											<div class="form-group">
												<label for="TransportistaDiasEntrega">Dias de entrega <small>Ej. 2 días hábiles</small></label>
												<input type="text" class="form-control" name="TransportistaDiasEntrega" value="<?php echo $transportista['TRANSPORTISTA_DIAS_ENTREGA']; ?>">
											</div>
										</div>
									</div>
								</div>
										...
										<div class="card-body">
											<div class="form-group">
												...
												<select class="form-control" name="Estado">
													<option value="activo" <?php if($transportista['ESTADO']=='activo'){ echo 'selected'; } ?>>Activo</option>
													<option value="inactivo" <?php if($transportista['ESTADO']=='inactivo'){ echo 'selected'; } ?>>Inactivo</option>
												</select>
											</div>
											<hr>
												<img src="<?php echo base_url('contenido/img/transportistas/'.$transportista['IMAGEN']); ?>" alt="" class="img-fluid mx-auto mb-2">
												<div class="form-group">

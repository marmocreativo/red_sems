	...
	<div class="col-12 col-sm-6 col-md-4 mb-3">
			<div class="card">
				...
				<div class="card-body d-flex justify-content-between">
					<a href="<?php echo base_url('admin/repositorio?categoria='.$categoria->ID_CATEGORIA.'&orden_cat'.$consulta['orden_cat'].'&busqueda'.$consulta['busqueda']); ?>">
				  ...
				  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
						<a href="#" data-toggle="modal" class="dropdown-item" data-target="#editar-<?php echo $categoria->ID_CATEGORIA; ?>"><i class="fa fa-pencil"></i>Editar</a>
				    <a class="dropdown-item" href="<?php echo base_url('admin/repositorio/borrar_carpeta?id='.$categoria->ID_CATEGORIA.'&categoria='.$consulta['categoria'].'&orden_cat='.$consulta['orden_cat'].'&busqueda='.$consulta['busqueda']); ?>"><i class="fa fa-trash"></i> Borrar</a>
				  </div>
				</div>
			</div>
			<!-- Formulario -->
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="" action="<?php echo base_url('admin/repositorio/actualizar_carpeta'); ?>" method="post" enctype="multipart/form-data">
								...
								<img src="<?php echo base_url('contenido/img/categorias/'.$categoria->IMAGEN); ?>" width="300px" class="d-block mx-auto" alt="">
								<div class="form-group">
									<label for="Imagen">Imagen</label>
									<input type="file" class="form-control" name="Imagen" value="">
								</div>
								<div class="form-group">
									<label for="TamanoImagen">Tamaño Imagen</label>
									<select class="form-control" name="TamanoImagen">
										<option value="default" selected>Default (rectangular)</option>
										<option value="destacada">Destacada (cuadrada)</option>
									</select>
								</div>
								<hr>

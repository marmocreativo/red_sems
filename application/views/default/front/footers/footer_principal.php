<!-- start footer Area -->
			...
			<script src="<?php echo base_url('assets/redsems'); ?>/js/vendor/jquery-2.2.4.min.js"></script>
			<script src="<?php echo base_url('assets/redsems'); ?>/js/vendor/bootstrap.min.js"></script>
